...
jupyter-core jupyter-nbconvert gnome-tweaks jupyter-nbformat meld git-all markdown golang synaptic plank blueman bluez-cups bluez-obexd deepin-picker font-manager npm;
